...
def create_window():
    ...
    button1 = tk.Button(window, text="Play Obstacle", command=lambda: run_script('Obstacle.py'))
    button1.pack(pady=5)

    button2 = tk.Button(window, text="Play SecondRival", command=lambda: run_script('secondrival.py'))
    button2.pack(pady=5)
